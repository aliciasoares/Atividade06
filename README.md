# Fluxogramas
Essa pesquisa aborda o conceito de fluxogramas, fundamentais para a lógica de programação de forma aprofundada e explicada, além dos principais símbolos, seus respectivos significados e exemplos de fluxogramas funcionais.
...
Existem inúmeros símbolos que podem ser utilizados em um fluxograma para representar ações e decisões a serem tomadas durante seu processo.
...
1- Fluxograma representando um algoritmo que verifica se uma pessoa é maior ou menor de idade com base em um valor inserido para a idade.
...
2- Fluxograma que verifica se uma variável é uma letra maiúscula, minúscula ou um número.
